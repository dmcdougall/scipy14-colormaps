...
\begin{frame}[t]\frametitle{Lightness of matplotlib Colormaps}
    \begin{figure}[htbp]
        ...
        \includegraphics[width=\textwidth]{figures/Sequential2}
        }
    \end{figure}
    \only<1>{
    \vskip8ex
...
\begin{frame}[t]\frametitle{Lightness of matplotlib Colormaps}
    ...
    \begin{figure}[htbp]
        ...
        \only<2>{
        \includegraphics[width=0.8\textwidth]{figures/Diverging} \\
        \includegraphics[width=0.8\textwidth]{figures/Qualitative} \\
        \includegraphics[width=0.8\textwidth]{figures/Miscellaneous}
        }
    \end{figure}
    \only<1>{
    \tiny{http://matplotlib.org/examples/color/colormaps\_reference.html}}
...
\begin{frame}[t]\frametitle{Improvement to Binary Colormap?}
    \begin{figure}[htbp]
        \centering
        \only<1>{\includegraphics[width=\textwidth]{figures/Sequential}}
